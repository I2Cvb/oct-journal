...
\deleted[id=sik, remark={if dme is described so should be dr, and should be found right after the first sentence before States blabla. But I would just skip the definition since we dont use it.}]{
...
\added[id=sik, remark={i tried to refrase it couple of times, but no luck}]{
...
\todo{I'm not sure if this is how we should state the previous work, but I like its flow}
