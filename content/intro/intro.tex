...
However, the use of fundus photography is limited to the detection of signs which are correlated with retinal thickening such as hard and soft exudates, hemorrhages or micro-aneurysms except if multiple fundus images are used~\cite{giancardo2011textureless}.
However, only qualitative information can be inferred.
...
The new generation of \ac{oct} imaging, namely \ac{sdoct} offers higher resolution and faster image acquisition over conventional time domain \ac{oct}. \Ac{sdoct} can produce $27,000$ to $40,000$ A-scans/second with an axial resolution ranging from \SIrange{3.5}{6}{\micro \metre}~\cite{Chen2005}. 
...
This paper is organized as follows: Sect.\,\ref{sec:rw} presents a summary of the related studies;
