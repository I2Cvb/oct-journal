...
\begin{center}
\subfigure[Normal]{
\includegraphics[scale=0.15]{normal_case_inv.png}}\
\subfigure[\ac{dme}]{
\includegraphics[scale=0.15]{dme_case_inv.png}}
\end{center}
\caption{ Example of \ac{sdoct} images for normal and \ac{dme} patients.}
