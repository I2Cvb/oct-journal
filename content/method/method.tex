...
\begin{figure}[h]
\begin{center}
\subfigure[2D B-scan]{\includegraphics[width=0.3\textwidth]{/mapping/global-2d.png}}\hfill
\subfigure[3D volume]{\includegraphics[width=0.3\textwidth]{/mapping/global-3d.png}}
...
\begin{figure}[h]
\begin{center}
\subfigure[2D B-scan]{\includegraphics[width=0.3\textwidth]{/mapping/local-2d.png}}\hfill
\subfigure[3D volume]{\includegraphics[width=0.3\textwidth]{/mapping/local-3d.png}}
