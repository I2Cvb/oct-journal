...
For instance, \emph{local}-mapping results in a size of $N \times d \times LBP_{\#pat}$ for the final \ac{lbp} descriptor and $N' \times LBP_{\#pat}$ for the final \ac{lbptop} descriptor, where $N$ and $N'$ the total number of 2D patches and 3D sub-volumes, respectively.
