...
\added[id=sik]{
The main benefit of this proposal is richer configuration capabilities of several blocks conforming its original version presented in \cite{Lemaintre2015miccaiOCT}.}
