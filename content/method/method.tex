...
The influence of these pre-processing methods and their possible combinations are extensively studied in Sect.\,\ref{sec:}.\todo{add the section for the experiment flattening+aligned} 
...
\centering 
  \hspace*{\fill}
  \subfigure[]{\includegraphics[width=0.20\textwidth]{flattening/original_cropped}}\hfill
  \subfigure[]{\includegraphics[width=0.20\textwidth]{flattening/thresholding_cropped}}\hfill
  \subfigure[]{\includegraphics[width=0.20\textwidth]{flattening/median_cropped}}
  \hspace*{\fill}	
  \\
  \hspace*{\fill}
  \subfigure[]{\includegraphics[width=0.20\textwidth]{flattening/fit_cropped}}\hfill
  \subfigure[]{\includegraphics[width=0.20\textwidth]{flattening/warped_cropped}}\hfill
  \subfigure[]{\includegraphics[width=0.20\textwidth]{flattening/warped_org_cropped}}
  \hspace*{\fill}
...
However, the \ac{oct} scans suffers from large type of variations: inclination angles, positioning, and natural curvature of the retina~\cite{Liu2011}.
Therefore, these variations have to be taken into account to ensure a consistent characterization of the tissue disposition, regardless of the location in the retina.%, prior to build the textural descriptors.
%Therefore, to ensure a consistent characterization of the tissue disposition regardless of the location within the retina, the natural curvature of the retina needs to be corrected.
This invariance can be achieved from different manners: (i) using a descriptor allowing for a wide number of textures, so that each texture orientation accounts for each own descriptor, (ii) using a rotation invariant descriptor, or (iii) by unfolding the curvature of the retina.
%This can be done in different manners: (i) using a descriptor allowing for a wide number of textures, so that each texture orientation accounts for each own descriptor, (ii) using a rotation invariant descriptor, or (iii) by unfolding the curvature of the retina.
