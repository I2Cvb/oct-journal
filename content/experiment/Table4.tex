...
%\bigskip
%%-------------------------------------- svm knn
%\begin{tabularx}{1.02\linewidth}{l c  lcr c lcr c lcr cc lcr c lcr c lcr }
%\toprule
%& \multicolumn{11}{c}{\ac{svm}} & & & & \multicolumn{11}{c}{$k$-\ac{nn}} \\
%\cmidrule(l){3-13} \cmidrule(l){17-27}
...
%  \cmidrule(l){3-5}  \cmidrule(l){7-9}  \cmidrule(l){11-13} \cmidrule(l){17-19}  \cmidrule(l){21-23}  \cmidrule(l){25-27}
%   &  & 	\ac{se}\% &  & \ac{sp}\%  &    & 	\ac{se}\% &  & \ac{sp}\% &  & 	\ac{se}\% &  & \ac{sp}\% & & & 
%   \ac{se}\% &  & \ac{sp}\% &  & 	\ac{se}\% &  & \ac{sp}\% &  &  	\ac{se}\% &  & \ac{sp}\%\\
%\midrule
%  	\emph{global}-\ac{lbp}		\\
...
%\bigskip
%%-------------------------- LR 
%\begin{tabularx}{1.02\linewidth}{l c  lcr c lcr c lcr }
%\toprule
%& \multicolumn{11}{c}{\ac{lr}} \\
%\cmidrule(l){3-13} 
%Features &    &  \multicolumn{3}{c}{$8^{riu2}$}  & & \multicolumn{3}{c}{$16^{riu2}$} & & \multicolumn{3}{c}{$24^{riu2}$}  \\
