\begin{landscape}
  ...
  \begin{table}[ht]
\caption{Experiment \#2 - $k$-\ac{nn}, \ac{svm}, \ac{rf}, and \ac{gb} classification with \ac{bow} for the \emph{global} and \emph{local} \ac{lbp} and \emph{local} \ac{lbptop} features with different pre-processing. The optimum number of words were selected based on experiment~\#1.
