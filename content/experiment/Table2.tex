%\begin{tiny}
  \begin{table}[ht]
\caption{The obtained results of experiment \#2. $k$-\ac{nn} and  \ac{svm} classification with \ac{bow} for the \emph{global} and \emph{local} \ac{lbp} and \emph{local} \ac{lbptop} features with different pre-processing. The optimum number of words were selected based on the previous experiment.}
\centering
...
\midrule
  	\emph{global}-\ac{lbp}		\\
 	& \acs{nf} & 43.7 &  93.7 &   & 43.7 & 87.5  &  & 43.7  & 62.5   \\
	& \acs{f}  & 43.7 &  56.2 &   & 50.0 & 75.0  &  & 62.5  & 56.2 	 \\
	& \acs{fa} & 56.2 &  62.5 &   & 43.7 & 81.2  &  & 68.7  & 56.2	 \\
	& \acs{fac}& 50   &  75.0 &   & 37.5 & 87.5  &  & 50.0  & 62.5 	 \\
\hdashline \noalign{\vskip 3pt}
 	\emph{local}-\ac{lbp}		\\
 	& \acs{nf} & 75.0 & 87.5 & & 50.0  & 68.7 &  &  43.7  & 43.7    \\
	& \acs{f}  & 56.2 & 56.2 & & 50.0  & 50.0 &  & 50.0   & 43.7 \\
	& \acs{fa} & 56.2 & 43.7 & & 50.0  & 75.0 &  & 50.0   & 62.5   \\
	& \acs{fac}& 37.5 & 75.0 & & 31.2  & 75.0 &  & 62.5   & 81.2 	 \\
\hdashline \noalign{\vskip 3pt}
...
\begin{table}[ht]
\caption{The obtained results of experiment \#2. \ac{rf} and  \ac{gb} classification with \ac{bow} for the \emph{global} and \emph{local} \ac{lbp} and \emph{local} \ac{lbptop} features with different pre-processing. The optimum number of words were selected based on the previous experiment.}
\centering
...
\midrule
  	\emph{global}-\ac{lbp}		\\
 	& \acs{nf} & 68.7 & 93.7 & & 43.7 & 62.5 & & 50.0 & 68.7 \\
	& \acs{f}  & 56.2 & 50.0 & & 56.2 & 75.0 & & 50.0 & 75.0 \\
	& \acs{fa} & 68.7 & 50.0 & & 56.2 & 62.5 & & 62.5 & 56.2 \\
	& \acs{fac} & 68.7 & 68.7 & & 56.2 & 75.0 & & 50.0 & 68.7 \\ 
\hdashline \noalign{\vskip 3pt}
 	\emph{local}-\ac{lbp}		\\
 	& \acs{nf} &  81.2 & 81.2 & & 62.5 & 56.2 & & 56.2 & 56.2  \\
	& \acs{f}  &  56.2 & 81.2 & & 62.5 & 68.7 & & 68.7 & 62.5  \\
	& \acs{fa} &  68.7 & 62.5 & & 62.6 & 68.7 & & 43.7 & 43.7  \\
	& \acs{fac}&  62.5 & 68.7 & & 68.7 & 68.7 & & 68.7 & 56.2  \\
\hdashline \noalign{\vskip 3pt}
 	\emph{local}-\ac{lbptop}		\\
 	& \acs{nf}	 \\
	& \acs{f}		 \\
