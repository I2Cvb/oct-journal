...
To evaluate the effects and influence of different stages of our framework, we perform various tests using our own dataset.
% and sake of comparison, the optimal configurations are evaluated on a public dataset.
A detailed description of the used dataset can be found in \Cref{sec:exp:datasets}.
...
The obtained results of this test is represented in experiment~\#2.
