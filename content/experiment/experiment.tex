...
%% Experiment intro
This experiment intends to find the optimal number of words and its effect on the different configurations (i.e., {\color{red} Add the type of configuration or what it is}), on the contrary to~\cite{Lemaintre2015miccaiOCT}, where the codebook size was arbitrarily set to $k = 32$.
...
{\color{red} The choice of this linear classifier avoids that the results get boosted by the classifier.}
