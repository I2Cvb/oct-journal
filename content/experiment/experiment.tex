...
\acl{acc} measure the ration of correctly classified samples in comparison to all the samples, while \ac{f1} is the statistic measure between precision and \ac{se}.
%\input{Table1.tex}
