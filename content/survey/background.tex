...
\DTLloaddb[keys={task,Srinivasan,Venhuizen,Liu,Lemaitre}]{survey}{./content/survey/tables/survey.csv}
% \DTLloaddb[keys={task,Srinivasan,Score}]{survey}{./content/survey/tables/survey.csv}
