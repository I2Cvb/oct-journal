...
\replaced[id=sik]
{Then, each \ac{oct} volume is represented in terms of this codebook and characterized as a histogram that captures the codebook occurrences. These histograms are}
{Then, the obtained codebook from the training is used to represent each \ac{oct} volume as a feature \added[id=glm]{vector occurrence histogram}.
